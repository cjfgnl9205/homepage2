...
<form class="form-horizontal" action="createForm.jsp" method="post" onsubmit="return send()" name = "frm">
  
  <div class="form-group">
    <label class="control-label col-sm-1" for="content"></label>
    <div class="col-sm-8">
    <textarea rows="20" cols="100" id="content" name="content" class="form-control" readonly="readonly" disabled>Cummunity 서비스약관 (2005. 7. 18 부터 유효) 
